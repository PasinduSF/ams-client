...
function EmployeeFormDialog({ isOpen, onClose, onSubmit }) {
        ...
        >
          {({ isSubmitting }) => (
            <Form className="space-y-4">
              ...
              <div className='h-[80px]'>
                <label htmlFor="empNo" className="block text-sm font-medium text-gray-700 mb-1">Emp No</label>
                <Field
                  type="text"
                  id="empNo"
                  name="empNo"
                  className="w-full text-black px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <ErrorMessage name="empNo" component="div" className="text-red-500 text-xs mt-1" />
              </div>
              <div className='h-[80px]'>
